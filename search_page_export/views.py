...
class ExportFormView(CView):
    ...
    def get(self, request):
        ...
        ctx = {'csv_export_link': request.get_full_path().replace('/search_page_export_example/',
                                                                  '/search_page_export_example/csv/')}
        return Response(ctx)
...
class CsvExportView(CView):
    ...
    def post(self, request):
        ...
        # any non-empry value in export_item_id means we include that data
